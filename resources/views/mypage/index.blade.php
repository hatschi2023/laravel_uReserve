<x-app-layout>
                ...
                <section class="text-gray-600 body-font">
                    ...
                    <div class="container px-5 py-4 mx-auto">
                        ...
                        <div class="w-full mx-auto overflow-auto">
                            ...
                            <thead>
                                <tr>
                                    <th class="px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-200 rounded-l rounded-bl">イベント名</th>
                                    ...
                                    <th class="px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-200 rounded-r">予約人数</th>
    ...
    <div class="py-4">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-4">
                <h2 class="text-center pt-4 text-lg">過去のイベント一覧</h2>
                <section class="text-gray-600 body-font">
